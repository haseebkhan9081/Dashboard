  ...
  return (
    <div>
      ...
      {data && Object.keys(data).length > 0 ? (
            ...
            <table className="w-full border border-primary border-collapse">
              <thead>
                <tr className="border-b border-primary">
                  <th className="p-2 border-r border-primary">AC-No</th>
                  <th className="p-2 border-r border-primary">Name</th>
                  <th className="p-2 border-r border-primary">Date</th>
                  <th className="p-2 border-r border-primary">Time</th>
        ...
        <p
        className='text-center'>No data available</p>
      )}
    </div>
  );
};
